function carregaTabela(){
	...
	$.post('amigosratinhosGestaoDados.php', {funcao: 'obtem_tabela_por_nome', args: filtro}, function (resposta){
...
function alteraItem(id){
	...
	$.post('amigosratinhosGestaoDados.php', {funcao: 'obtem_item_por_id', args: filtro}, function (resposta){
...
function removeItem(id){
	if(confirm("Você está certo disso?")){
		...
		$.post('amigosratinhosGestaoDados.php', {funcao: 'remover', args: filtro}, function(resposta){			
			alert(resposta);
			fechaModal();
			carregaTabela();
		});
